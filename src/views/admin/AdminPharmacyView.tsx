      ...
      {activeTab === 'dispense' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              <span className="text-xs font-bold text-blue-700 uppercase">Dispensed Today</span>
              <p className="text-2xl font-bold text-blue-900 mt-1">
                {dispenses.filter((d) => d.status === 'dispensed').length}
              </p>
              <p className="text-xs text-blue-700 mt-1">Completed patient releases</p>
            </div>
          </div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                      <div className="space-y-2">
                        ...
                        {dsp.counseling_notes && (
                          <p className="text-xs text-blue-800 bg-blue-50 px-3 py-1.5 rounded border border-blue-200">
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {dsp.status === 'dispensed' && (
                          <span className="text-xs text-blue-700 font-medium flex items-center gap-1 px-3 py-2 bg-blue-50 rounded-lg">
                            <CheckCircle className="w-3.5 h-3.5" />
        ...
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-semibold rounded-lg bg-blue-700 text-white hover:bg-blue-800 flex items-center gap-1.5 shadow-sm self-end sm:self-auto"
            >
              ...
              <div className="border-b border-slate-300 pb-2 flex items-center justify-between">
                <div>
                  <h3 className="font-bold text-xs uppercase tracking-wider text-blue-800">
                    MAKATI MEDICAL CENTER PHARMACY
                  </h3>
          ...
          <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl space-y-4">
            ...
            <form onSubmit={handleAddItemSubmit} className="space-y-4 text-xs">
              ...
              <div className="flex justify-end gap-2 pt-2 border-t">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-blue-700 text-white hover:bg-blue-800 font-semibold shadow-sm"
                >
                  Save Medication
                </button>
              </div>
